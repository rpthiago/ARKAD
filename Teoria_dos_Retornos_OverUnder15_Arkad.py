...
def TR_OverUnder15():
    for i in ligas:
        ...
        winHPLValues = 100 * df.FT_Odd_Over15 - 100
        winAPLValues = 100 * df.FT_Odd_Under15 - 100
        losePLValues = -100
        
        df.loc[((df['TotalGoals']) > 1), 'Over_Under'] = 'Over'
        df.loc[((df['TotalGoals']) < 2), 'Over_Under'] = 'Under'
        ...
        for index, row in df2.iterrows():
            if index > 26:
                try:
                    ...
                    if h > a:
                        df3.loc[index, 'R'] = 'Over15'
                    else:
                        df3.loc[index, 'R'] = 'Under15'
                except LookupError:
                    pass
...
nome = 'Teoria_dos_Retornos_Over_Under_15.csv'
