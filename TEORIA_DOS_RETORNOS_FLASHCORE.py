...
def TR():
    for i in ligas:
        ...
        if liga == "AZERBAIJAN - PREMIER LEAGUE":
            df = base[base.League == liga]
        if liga == "BAHRAIN - PREMIER LEAGUE":
            df = base[base.League == liga]
        ...
        if liga == "BOLIVIA - DIVISION PROFESIONAL":
            df = base[base.League == liga]
        if liga == "BOSNIA AND HERZEGOVINA - PREMIER LEAGUE":
            df = base[base.League == liga]
        ...
        if liga == "CROATIA - PRVA NL":
            df = base[base.League == liga]
        if liga == "CYPRUS - FIRST DIVISION":
            df = base[base.League == liga]
        if liga == "CZECH REPUBLIC - 1. LIGA":
            df = base[base.League == liga]
        ...
        if liga == "SERBIA - SUPER LIGA":
            df = base[base.League == liga]
        if liga == "SLOVAKIA - FORTUNA LIGA":
            df = base[base.League == liga]
        if liga == "SLOVENIA - PRVA LIGA":
            df = base[base.League == liga]
        if liga == "SOUTH AFRICA - PREMIER LEAGUE":
            df = base[base.League == liga]
        ...
        if liga == "USA - USL CHAMPIONSHIP":
            df = base[base.League == liga]
        if liga == "VENEZUELA - PRIMERA DIVISION":
            df = base[base.League == liga]
...
# data = hoje()
# hoje = data.strftime('%Y-%m-%d')
# nome = 'Teoria_dos_Retornos_Over_Under_ARKAD.csv'
# df00.to_csv(f'./Teoria_dos_Retornos/{hoje}_{nome}', index = False)
# df00
