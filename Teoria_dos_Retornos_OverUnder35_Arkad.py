...
def TR_OverUnder35():
    for i in ligas:
        ...
        winHPLValues = 100 * df.FT_Odd_Over35 - 100
        winAPLValues = 100 * df.FT_Odd_Under35 - 100
        losePLValues = -100
        
        df.loc[((df['TotalGoals']) > 3), 'Over_Under'] = 'Over'
        df.loc[((df['TotalGoals']) < 4), 'Over_Under'] = 'Under'
        ...
        for index, row in df2.iterrows():
            if index > 26:
                try:
                    ...
                    if h > a:
                        df3.loc[index, 'R'] = 'Over35'
                    else:
                        df3.loc[index, 'R'] = 'Under35'
                except LookupError:
                    pass
...
nome = 'Teoria_dos_Retornos_Over_Under_35.csv'
