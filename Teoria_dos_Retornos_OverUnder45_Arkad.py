...
def TR_OverUnder45():
    for i in ligas:
        ...
        winAPLValues = 100 * df.FT_Odd_Under45 - 100
        losePLValues = -100
        
        df.loc[((df['TotalGoals']) > 4), 'Over_Under'] = 'Over'
        df.loc[((df['TotalGoals']) < 5), 'Over_Under'] = 'Under'
...
nome = 'Teoria_dos_Retornos_Over_Under_45.csv'
