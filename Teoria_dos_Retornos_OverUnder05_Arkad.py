...
def TR_OverUnder05():
    for i in ligas:
        ...
        winAPLValues = 100 * df.FT_Odd_Under05 - 100
        losePLValues = -100
        
        df.loc[((df['TotalGoals']) > 0), 'Over_Under'] = 'Over'
        df.loc[((df['TotalGoals']) < 1), 'Over_Under'] = 'Under'
...
nome = 'Teoria_dos_Retornos_Over_Under_05.csv'
